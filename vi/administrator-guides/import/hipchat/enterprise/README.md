...
To import your current data from HipChat Enterprise into Goalify.Chat, please do the following.
...
2. Ensure the file generated is a `tar.gz` file, otherwise Goalify.Chat won't accept it.
3. Go to `https://[your_rocketchat]/admin/import/prepare/hipchatenterprise`
4. Choose your decrypted `tar.gz` file and wait until Goalify.Chat can read it (it can take a few minutes, depending on the size of your export)
